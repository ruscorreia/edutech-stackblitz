                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Conteudos do ensino primário</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Faça perguntas ao assistente</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Faça a sua pergunta (Ex.: o que são adverbios?)"
                            disabled={isLoading}
